...
func TestNoCommandDebug(t *testing.T) {
	result := `{"Type":"*errs.Error","Err":{"Type":"*errors.errorString","Msg":"no command"},"Context":{"function":"github.com/spiegel-im-spiegel/go-minimal-package/facade.newRootCmd.func1"}}` + "\n"
